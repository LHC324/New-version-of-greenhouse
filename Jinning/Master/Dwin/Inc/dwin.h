...
#define DWIN_SYSTEM_READ_RTC_ADDR 0x0010
...
/*参数存储区*/
#define PRESSURE_OUT_ADDR 0x107C	//压力输出地址
...
#define BOARD_TYPE_ADDR 0x1200	//板卡类型显示地址
#define ERROR_CODE_ADDR 0x1100	//错误代码地址
#define ERROR_ANMATION 0x1101	//错误动画地址
#define RSURE_CODE 0x00F1		//恢复出厂设置确认键值
#define RCANCEL_CODE 0x00F0		//注销键值
/*板卡卡槽地址*/
#define CARD_SLOT1_ADDR 0x1200
#define CARD_SLOT2_ADDR 0x1201
#define CARD_SLOT3_ADDR 0x1202
#define CARD_SLOT4_ADDR 0x1203
#define CARD_SLOT5_ADDR 0x1204
#define CARD_SLOT6_ADDR 0x1205
#define CARD_SLOT7_ADDR 0x1206
#define CARD_SLOT8_ADDR 0x1207
#define CARD_SLOT9_ADDR 0x1208
#define CARD_SLOT10_ADDR 0x1209
#define CARD_SLOT11_ADDR 0x120A
#define CARD_SLOT12_ADDR 0x120B
#define CARD_SLOT13_ADDR 0x120C
#define CARD_SLOT14_ADDR 0x120D
#define CARD_SLOT15_ADDR 0x120E
#define CARD_SLOT16_ADDR 0x120F
/*板卡类型显示基地址*/
#define CARD_TYPE_BASE_ADDR 0x1200
/*同类型板卡区分地址*/
#define CARD_SAMETYPE_DIFF_ADDR 0x1300

//系統工作时间段设置
#define SYS_START_WH_ADDR 0x10A0
#define SYS_START_WM_ADDR 0x10A1
#define SYS_START_WS_ADDR 0x10A2
#define SYS_STOP_WH_ADDR  0x10A3
#define SYS_STOP_WM_ADDR  0x10A4
#define SYS_STOP_WS_ADDR  0x10A5
