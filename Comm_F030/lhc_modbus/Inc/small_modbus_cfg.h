...
//  <0-1024>
/*small_modbus数据缓冲区尺寸*/
#define SMODBUS_RX_BUF_SIZE 92

// <o>Set the buffer size of lhc modbus sending thread
//  <i>Default: 128 (Unit: byte)
//  <0-1024>
#define SMODBUS_TX_BUF_SIZE 92
...
//  <0-1024>
/*寄存器池尺寸*/
#define SMODBUS_REG_POOL_SIZE 92U
...
// <c1>Enable special information reporting
//  <i>Enable HAL Driver Component
/*启用特殊信息上报*/
#define SMODBUS_USING_REPORT_INFO
// </c>
...
/*small modbus调试接口*/
#define SMODBUS_SHELL &shell
#define SMODBUS_DEBUG(fmt, ...) shellPrint(SMODBUS_SHELL, fmt, ##__VA_ARGS__)
